...
//   const appAccountKey = new ViemLocalEip712Signer({ address: account.address, nonceManager: undefined, sign: undefined, signAuthorization: undefined, signTypedData: undefined, getHdKey: undefined, type: "local" });
